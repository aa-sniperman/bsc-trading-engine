...
export interface PancackeV3RouterInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "WETH9"
      | "deployer"
...
export interface PancackeV3Router extends BaseContract {
  connect(runner?: ContractRunner | null): PancackeV3Router;
  waitForDeployment(): Promise<this>;

  interface: PancackeV3RouterInterface;
