...
export interface PancackeRouterInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "WETH"
      | "addLiquidity"
...
export interface PancackeRouter extends BaseContract {
  connect(runner?: ContractRunner | null): PancackeRouter;
  waitForDeployment(): Promise<this>;

  interface: PancackeRouterInterface;
